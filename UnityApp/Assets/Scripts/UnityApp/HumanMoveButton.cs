...
namespace ColorShapeLinks.UnityApp
{
    ...
    public class HumanMoveButton : MonoBehaviour
    {
        ...
        private float fadeMinTransparency = 0.2f;
        ...
        /// <summary>
        /// Open or close the arrow button. An open button can be clicked,
        /// usually meaning that the associated column still has space for at
        /// least one more piece. A closed button cannot be clicked, and
        /// usually implies that the associated column is full.
        /// </summary>
        /// <value>
        ...
        public bool Open
        {
            set
            {
                // Basically, the collider being enable or not defines whether
                // the button is open or closed
        ...
        {
            // When the arrow is enabled, make sure it doesn't get stuck with
            // the arrowDrop sprite
        ...
        private void Update()
        {
            // Apply fade in/out effect if button is open and not hovered by
            // mouse

...
Last update: Thu, 11 Jun 2020 20:58:12 GMT
...
| White |   Red   | Details |
| -----:|:------- | :-----: |
| `NegamaxH01D3` | **`ThunderV2`** | [+](results/NegamaxH01D3vsThunderV2.txt) |
| **`ThunderV2`** | `NegamaxH01D3` | [+](results/ThunderV2vsNegamaxH01D3.txt) |
...
| **`MinimaxD2`** | `ThunderV2` | [+](results/MinimaxD2vsThunderV2.txt) |
| `ThunderV2` | **`MinimaxD2`** | [+](results/ThunderV2vsMinimaxD2.txt) |
...
| `ThunderV2` | **`Omega Thonk Tank`** | [+](results/ThunderV2vsOmegaThonkTank.txt) |
| **`Omega Thonk Tank`** | `ThunderV2` | [+](results/OmegaThonkTankvsThunderV2.txt) |
...
| **`ThunderV2`** | `Sequential` | [+](results/ThunderV2vsSequential.txt) |
| **`Sequential`** | `ThunderV2` | [+](results/SequentialvsThunderV2.txt) |
...
| `ThunderV2` | **`TheBenchmark`** | [+](results/ThunderV2vsTheBenchmark.txt) |
| **`TheBenchmark`** | `ThunderV2` | [+](results/TheBenchmarkvsThunderV2.txt) |
...
| `Coac` | **`ThunderV2`** | [+](results/CoacvsThunderV2.txt) |
| **`ThunderV2`** | `Coac` | [+](results/ThunderV2vsCoac.txt) |
...
| **`SureAIv30`** | `ThunderV2` | [+](results/SureAIv30vsThunderV2.txt) |
| `ThunderV2` | **`SureAIv30`** | [+](results/ThunderV2vsSureAIv30.txt) |
...
| **`Random`** | `ThunderV2` | [+](results/RandomvsThunderV2.txt) |
| **`ThunderV2`** | `Random` | [+](results/ThunderV2vsRandom.txt) |

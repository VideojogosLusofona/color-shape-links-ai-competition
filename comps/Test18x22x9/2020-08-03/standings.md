...
Last update: Mon, 03 Aug 2020 21:28:34 GMT
...
| **`Random`** | `SimpAIV3` | [+](results/RandomvsSimpAIV3.txt) |
| **`SimpAIV3`** | `Random` | [+](results/SimpAIV3vsRandom.txt) |
...
| `NegamaxH01D3` | **`SimpAIV3`** | [+](results/NegamaxH01D3vsSimpAIV3.txt) |
| **`SimpAIV3`** | `NegamaxH01D3` | [+](results/SimpAIV3vsNegamaxH01D3.txt) |
...
| **`ThunderV9`** | `SimpAIV3` | [+](results/ThunderV9vsSimpAIV3.txt) |
| `SimpAIV3` | **`ThunderV9`** | [+](results/SimpAIV3vsThunderV9.txt) |
...
| **`MinimaxD2`** | `SimpAIV3` | [+](results/MinimaxD2vsSimpAIV3.txt) |
| `SimpAIV3` | **`MinimaxD2`** | [+](results/SimpAIV3vsMinimaxD2.txt) |
...
| `SimpAIV3` | **`Omega Thonk Tank`** | [+](results/SimpAIV3vsOmegaThonkTank.txt) |
| **`Omega Thonk Tank`** | `SimpAIV3` | [+](results/OmegaThonkTankvsSimpAIV3.txt) |
...
| **`SimpAIV3`** | `Sequential` | [+](results/SimpAIV3vsSequential.txt) |
| **`Sequential`** | `SimpAIV3` | [+](results/SequentialvsSimpAIV3.txt) |
...
| `SimpAIV3` | **`TheBenchmark`** | [+](results/SimpAIV3vsTheBenchmark.txt) |
| **`TheBenchmark`** | `SimpAIV3` | [+](results/TheBenchmarkvsSimpAIV3.txt) |
...
| **`SimpAIV3`** | `Coac` | [+](results/SimpAIV3vsCoac.txt) |
| `Coac` | **`SimpAIV3`** | [+](results/CoacvsSimpAIV3.txt) |
...
| **`IAD2`** | `SimpAIV3` | [+](results/IAD2vsSimpAIV3.txt) |
| `SimpAIV3` | **`IAD2`** | [+](results/SimpAIV3vsIAD2.txt) |
...
| **`SureAIv30`** | `SimpAIV3` | [+](results/SureAIv30vsSimpAIV3.txt) |
| `SimpAIV3` | **`SureAIv30`** | [+](results/SimpAIV3vsSureAIv30.txt) |

...
Last update: Wed, 29 Jul 2020 20:45:59 GMT
...
| `Random` | **`SimpAIV2`** | [+](results/RandomvsSimpAIV2.txt) |
| `SimpAIV2` | **`Random`** | [+](results/SimpAIV2vsRandom.txt) |
...
| `NegamaxH01D3` | **`SimpAIV2`** | [+](results/NegamaxH01D3vsSimpAIV2.txt) |
| **`SimpAIV2`** | `NegamaxH01D3` | [+](results/SimpAIV2vsNegamaxH01D3.txt) |
...
| **`ThunderV9`** | `SimpAIV2` | [+](results/ThunderV9vsSimpAIV2.txt) |
| `SimpAIV2` | **`ThunderV9`** | [+](results/SimpAIV2vsThunderV9.txt) |
...
| **`MinimaxD2`** | `SimpAIV2` | [+](results/MinimaxD2vsSimpAIV2.txt) |
| `SimpAIV2` | **`MinimaxD2`** | [+](results/SimpAIV2vsMinimaxD2.txt) |
...
| `SimpAIV2` | **`Omega Thonk Tank`** | [+](results/SimpAIV2vsOmegaThonkTank.txt) |
| **`Omega Thonk Tank`** | `SimpAIV2` | [+](results/OmegaThonkTankvsSimpAIV2.txt) |
...
| **`SimpAIV2`** | `Sequential` | [+](results/SimpAIV2vsSequential.txt) |
| **`Sequential`** | `SimpAIV2` | [+](results/SequentialvsSimpAIV2.txt) |
...
| `SimpAIV2` | **`TheBenchmark`** | [+](results/SimpAIV2vsTheBenchmark.txt) |
| **`TheBenchmark`** | `SimpAIV2` | [+](results/TheBenchmarkvsSimpAIV2.txt) |
...
| **`SimpAIV2`** | `Coac` | [+](results/SimpAIV2vsCoac.txt) |
| `Coac` | **`SimpAIV2`** | [+](results/CoacvsSimpAIV2.txt) |
...
| **`IAD2`** | `SimpAIV2` | [+](results/IAD2vsSimpAIV2.txt) |
| `SimpAIV2` | **`IAD2`** | [+](results/SimpAIV2vsIAD2.txt) |
...
| **`SureAIv30`** | `SimpAIV2` | [+](results/SureAIv30vsSimpAIV2.txt) |
| `SimpAIV2` | **`SureAIv30`** | [+](results/SimpAIV2vsSureAIv30.txt) |

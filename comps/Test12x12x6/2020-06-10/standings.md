...
Last update: Wed, 10 Jun 2020 20:40:29 GMT
...
| White |   Red   | Details |
| -----:|:------- | :-----: |
| `NegamaxH01D3` | **`ThunderV1`** | [+](results/NegamaxH01D3vsThunderV1.txt) |
| **`ThunderV1`** | `NegamaxH01D3` | [+](results/ThunderV1vsNegamaxH01D3.txt) |
...
| **`MinimaxD2`** | `ThunderV1` | [+](results/MinimaxD2vsThunderV1.txt) |
| `ThunderV1` | **`MinimaxD2`** | [+](results/ThunderV1vsMinimaxD2.txt) |
...
| `ThunderV1` | **`Omega Thonk Tank`** | [+](results/ThunderV1vsOmegaThonkTank.txt) |
| **`Omega Thonk Tank`** | `ThunderV1` | [+](results/OmegaThonkTankvsThunderV1.txt) |
...
| **`ThunderV1`** | `Sequential` | [+](results/ThunderV1vsSequential.txt) |
| `Sequential` | **`ThunderV1`** | [+](results/SequentialvsThunderV1.txt) |
...
| `ThunderV1` | **`TheBenchmark`** | [+](results/ThunderV1vsTheBenchmark.txt) |
| **`TheBenchmark`** | `ThunderV1` | [+](results/TheBenchmarkvsThunderV1.txt) |
...
| `Coac` | **`ThunderV1`** | [+](results/CoacvsThunderV1.txt) |
| **`ThunderV1`** | `Coac` | [+](results/ThunderV1vsCoac.txt) |
...
| **`SureAIv30`** | `ThunderV1` | [+](results/SureAIv30vsThunderV1.txt) |
| `ThunderV1` | **`SureAIv30`** | [+](results/ThunderV1vsSureAIv30.txt) |
...
| `Random` | **`ThunderV1`** | [+](results/RandomvsThunderV1.txt) |
| **`ThunderV1`** | `Random` | [+](results/ThunderV1vsRandom.txt) |
